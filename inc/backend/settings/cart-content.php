    ...
    <div class="majc-submenu-content">
        <div class="majc-submenu-section" id="majc-header-sub-section">
            ...
            <div class="majc-settings-row">
                ...
                <div class="majc-settings-fields">
                    <input type="text" name="majc_settings[header][title_text]" value="<?php echo isset($majc_header['title_text']) ? esc_attr($majc_header['title_text']) : null; ?>">
                </div>
            </div>
                ...
                <div class="majc-settings-fields">
                    <div class="majc-settings-list-row">
                        ...
                        <div class="majc-settings-list" data-condition-toggle="majc-header-icon-type" data-condition-val="available_icon">
                            ...
                            <?php
                            $majc_input_name = 'majc_settings[header][available_icon]';
                            $majc_icon_name = isset($majc_header['available_icon']) ? $majc_header['available_icon'] : null; //icon value from db
                            ...
                            <div class="majc-icon-image-uploader">
                                <div class="majc-custom-img-icon-btn">
                                    <div class="majc-custom-menu-image-icon current-bg-image">
                                        <?php if (isset($majc_header['custom_icon']) && !empty($majc_header['custom_icon'])) { ?>
                                            <img src="<?php echo isset($majc_header['custom_icon']) ? esc_url($majc_header['custom_icon']) : ''; ?>" />
                                        <?php } ?>
                                    </div>
                                ...
                                <input type="hidden" class="majc-upload-background-url" name="majc_settings[header][custom_icon]" id="majc-header-icon" value="<?php echo isset($majc_header['custom_icon']) ? esc_url($majc_header['custom_icon']) : ''; ?>" />
        ...
        <div class="majc-submenu-section" id="majc-cart-items-sub-section" style="display: none">
            ...
            <div class="majc-settings-row">
                ...
                <div class="majc-settings-fields majc-toggle-input-field">
                    ...
                    if (isset($majc_header['show_cart_item_count'])) {
                        checked($majc_header['show_cart_item_count'], 'on', true);
                    }
                    ?>>
                </div>
            </div>
        ...
        <div class="majc-submenu-section" id="majc-coupon-sub-section" style="display: none">
            ...
            <div class="majc-settings-row">
                ...
                <div class="majc-settings-fields majc-toggle-input-field">
                    ...
                    if (isset($majc_coupon['enable'])) {
                        checked($majc_coupon['enable'], 'on', true);
                    }
            ...
            <div class="majc-settings-row" data-condition-toggle="majc-enable-coupon">
                ...
                <div class="majc-settings-fields">
                    <input type="text" name="majc_settings[coupon][button_text]" value="<?php echo isset($majc_coupon['button_text']) ? esc_html($majc_coupon['button_text']) : null; ?>">
                </div>
            </div>
            ...
            <div class="majc-settings-row" data-condition-toggle="majc-enable-coupon">
                ...
                <div class="majc-settings-fields">
                    <input type="text" name="majc_settings[coupon][promocode_placeholder]" value="<?php echo isset($majc_coupon['promocode_placeholder']) ? esc_html($majc_coupon['promocode_placeholder']) : null; ?>">
                </div>
            </div>
        </div>
        ...
        <div class="majc-submenu-section" id="majc-button-sub-section" style="display: none">
                    ...
                    <div class="majc-settings-list-row">
                        <div class="majc-settings-list">
                            ...
                            <div class="majc-toggle-input-field">
                                ...
                                if (isset($majc_buttons['show_view_cart'])) {
                                    checked($majc_buttons['show_view_cart'], 'on', true);
                                }
                        ...
                        <div class="majc-settings-list" data-condition-toggle="majc-show-cart-button">
                            ...
                            <input type="text" name="majc_settings[buttons][view_cart_label]" value="<?php echo isset($majc_buttons['view_cart_label']) ? esc_html($majc_buttons['view_cart_label']) : esc_html__('View Cart', 'mini-ajax-cart'); ?>">
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <div class="majc-settings-list-row">
                        <div class="majc-settings-list">
                            ...
                            <div class="majc-toggle-input-field">
                                ...
                                if (isset($majc_buttons['show_checkout'])) {
                                    checked($majc_buttons['show_checkout'], 'on', true);
                                }
                        ...
                        <div class="majc-settings-list" data-condition-toggle="majc-show-checkout-button">
                            ...
                            <input type="text" name="majc_settings[buttons][checkout_label]" value="<?php echo isset($majc_buttons['checkout_label']) ? esc_html($majc_buttons['checkout_label']) : esc_html__('View Checkout', 'mini-ajax-cart'); ?>">
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <div class="majc-settings-list-row">
                        <div class="majc-settings-list">
                            ...
                            <div class="majc-toggle-input-field">
                                ...
                                if (isset($majc_buttons['show_continue_shopping'])) {
                                    checked($majc_buttons['show_continue_shopping'], 'on', true);
                                }
                        ...
                        <div class="majc-settings-list" data-condition-toggle="majc-show-shopping-button">
                            ...
                            <input type="text" name="majc_settings[buttons][continue_shopping_label]" value="<?php echo isset($majc_buttons['continue_shopping_label']) ? esc_html($majc_buttons['continue_shopping_label']) : esc_html__('Continue Shopping', 'mini-ajax-cart'); ?>">
                        </div>

                        <div class="majc-settings-list" data-condition-toggle="majc-show-shopping-button">
                            <label><?php esc_html_e('Continue Shopping Link', 'mini-ajax-cart'); ?></label>
                            <input type="text" name="majc_settings[buttons][continue_shopping_link]" value="<?php echo isset($majc_buttons['continue_shopping_link']) ? esc_url($majc_buttons['continue_shopping_link']) : ""; ?>">
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="majc-settings-row">
                ...
                <div class="majc-settings-fields">
                    <input type="text" name="majc_settings[buttons][shipping_text]" value="<?php echo isset($majc_buttons['shipping_text']) ? esc_html($majc_buttons['shipping_text']) : null; ?>">
            ...
            <div class="majc-settings-row">
                ...
                <div class="majc-settings-fields majc-toggle-input-field">
                    ...
                    if (isset($majc_summary['hide_cart_total'])) {
                        checked($majc_summary['hide_cart_total'], 'on', true);
                    }
                    ?>>
                </div>
            </div>
            ...
            <div class="majc-settings-row">
                ...
                <div class="majc-settings-fields majc-toggle-input-field">
                    ...
                    if (isset($majc_summary['hide_discount'])) {
                        checked($majc_summary['hide_discount'], 'on', true);
                    }
                    ?>>
                </div>
            </div>
            ...
            <div class="majc-settings-row">
                ...
                <div class="majc-settings-fields majc-toggle-input-field">
                    ...
                    if (isset($majc_summary['hide_subtotal'])) {
                        checked($majc_summary['hide_subtotal'], 'on', true);
                    }
                    ?>>
                </div>
            </div>
