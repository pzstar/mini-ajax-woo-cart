...
<div id="layout-settings" class="tab-content">
			...
			<select name="majc_settings[show_animation]">
				...
				<?php foreach ($animations['show_animation'] as $key => $key_array): ?>
					...
					<?php foreach ($key_array as $value): ?>
						<option value="<?php echo esc_attr($value) ?>" <?php if(isset($majc_settings['show_animation']) ) { selected($majc_settings['show_animation'], $value); } ?>><?php echo esc_attr($value) ?></option>
					<?php endforeach ?>
				<?php endforeach ?>
			</select>
		</div>
		...
		<div class="majc-settings-input-field">
			<select name="majc_settings[hide_animation]">
				...
				<?php foreach ($animations['hide_animation'] as $key => $key_array): ?>
					<optgroup label="<?php echo esc_attr($key) ?>"></optgroup>
					<?php foreach ($key_array as $value): ?>
						<option value="<?php echo esc_attr($value) ?>" <?php if(isset($majc_settings['hide_animation']) ) { selected($majc_settings['hide_animation'], $value); } ?>><?php echo esc_attr($value) ?></option>
					<?php endforeach ?>
				<?php endforeach ?>
			</select>
		</div>
	...
	<div class="majc-settings-field">
		...
		<div class="majc-settings-input-field">
			<select name="majc_settings[layout_type]" class="layout_type">			
				<option value="slidein" <?php if(isset($majc_settings['layout_type'])) { selected( $majc_settings['layout_type'], 'slidein' ); } ?>><?php esc_html_e('Slide In', 'mini-ajax-cart'); ?></option>
				<option disabled value="floating" <?php if(isset($majc_settings['layout_type'])) { selected( $majc_settings['layout_type'], 'floating' ); } ?>><?php esc_html_e('Floating', 'mini-ajax-cart'); ?></option>
				<option disabled value="popup" <?php if(isset($majc_settings['layout_type'])) { selected( $majc_settings['layout_type'], 'popup' ); } ?>><?php esc_html_e('Popup', 'mini-ajax-cart'); ?></option>
			</select>
		</div>
	</div>
	...
	<div class="majc-settings-field">
		...
		<div class="majc-settings-input-field">
			<input type="checkbox" name="majc_settings[enable_ajax_atc]" <?php if(isset($majc_settings['enable_ajax_atc'])) { checked( $majc_settings['enable_ajax_atc'], 'on', true ); } ?>>
		</div>
	</div>
	...
	<div class="majc-settings-field">
		...
		<div class="majc-settings-input-field">
			<select name="majc_settings[basket_position]">
				<option value="left-middle" <?php if(isset($majc_settings['basket_position'])) { selected($majc_settings['basket_position'], 'left-middle'); } ?>><?php esc_html_e('Left Middle', 'mini-ajax-cart'); ?></option>
				<option value="right-middle" <?php if(isset($majc_settings['basket_position'])) { selected($majc_settings['basket_position'], 'right-middle'); } ?>><?php esc_html_e('Right Middle', 'mini-ajax-cart'); ?></option>
			</select>
		</div>
	</div>
	...
	<div class="majc-settings-field">
		...
		<div class="majc-settings-input-field">
			<select name="majc_settings[cart_item_layout]">
				<option value="list" <?php if(isset($majc_settings['cart_item_layout'])) { selected($majc_settings['cart_item_layout'], 'list'); } ?>><?php esc_html_e('List', 'mini-ajax-cart'); ?></option>\
				<option value="grid" <?php if(isset($majc_settings['cart_item_layout'])) { selected($majc_settings['cart_item_layout'], 'grid'); } ?>><?php esc_html_e('Grid', 'mini-ajax-cart'); ?></option>
			</select>
		</div>
	</div>		
	...
	<div class="majc-settings-field">
		...
		<div class="majc-settings-input-field">
			<input type="checkbox" name="majc_settings[enable_overlay]" <?php if(isset($majc_settings['enable_overlay'])) { checked( $majc_settings['enable_overlay'], 'on', true ); } ?>>
		</div>
	</div>
	...
	<div class="majc-settings-field-wrap majc-settings-content">
		...
		<div class="majc-settings-field">
			...
			<div class="majc-settings-input-field">
				<select name="majc_settings[header][icon_type]" onchange="hideShow(this)" target="majc-icon-option-field">
					<option value="none" <?php if(isset($header['icon_type'])) { selected($header['icon_type'], 'none'); } ?>><?php esc_html_e('None', 'mini-ajax-cart'); ?></option>
					<option value="default_icon" <?php if(isset($header['icon_type'])) { selected( $header['icon_type'], 'default_icon' ); } ?>><?php esc_html_e('Default Icon', 'mini-ajax-cart'); ?></option>
					<option value="available_icon" <?php if(isset($header['icon_type'])) { selected($header['icon_type'], 'available_icon'); } ?>><?php esc_html_e('Available Icon', 'mini-ajax-cart'); ?></option>
					<option value="custom_icon" <?php if(isset($header['icon_type'])) { selected($header['icon_type'], 'custom_icon'); } ?>><?php esc_html_e('Custom Icon', 'mini-ajax-cart'); ?></option>
				</select>
			</div>
		</div>
		...
		<div class="majc-settings-field">
			...
			<div class="majc-settings-input-field">
				<input type="checkbox" name="majc_settings[header][show_cart_item_count]" <?php if(isset($header['show_cart_item_count'])) { checked( $header['show_cart_item_count'], 'on', true ); } ?>>
			</div>
		</div>
	</div>
	...
	<div class="majc-settings-field-wrap majc-settings-content">
			...
			<div class="majc-settings-field">
				...
				<div class="majc-settings-input-field">
					<select name="majc_settings[cart_basket][open_icon_type]" onchange="hideShow(this)" target="majc-icon-open-option-field">
						<option value="none" <?php if(isset($cart_basket['open_icon_type'])) { selected($cart_basket['open_icon_type'], 'none'); } ?>><?php esc_html_e('None', 'mini-ajax-cart'); ?></option>
						<option value="default_icon" <?php if(isset($cart_basket['open_icon_type'])) { selected( $cart_basket['open_icon_type'], 'default_icon' ); } ?>><?php esc_html_e('Default Icon', 'mini-ajax-cart'); ?></option>
						<option value="available_icon" <?php if(isset($cart_basket['open_icon_type'])) { selected($cart_basket['open_icon_type'], 'available_icon'); } ?>><?php esc_html_e('Available Icon', 'mini-ajax-cart'); ?></option>
						<option value="custom_icon" <?php if(isset($cart_basket['open_icon_type'])) { selected($cart_basket['open_icon_type'], 'custom_icon'); } ?>><?php esc_html_e('Custom Icon', 'mini-ajax-cart'); ?></option>
					</select>
				</div>
			</div>
			...
			<div class="majc-settings-field">
				...
				<div class="majc-settings-input-field">
					<select name="majc_settings[cart_basket][close_icon_type]" onchange="hideShow(this)" target="majc-icon-close-option-field">
						<option value="none" <?php if(isset($cart_basket['close_icon_type'])) { selected($cart_basket['close_icon_type'], 'none'); } ?>><?php esc_html_e('None', 'mini-ajax-cart'); ?></option>
						<option value="default_icon" <?php if(isset($cart_basket['close_icon_type'])) { selected( $cart_basket['close_icon_type'], 'default_icon' ); } ?>><?php esc_html_e('Default Icon', 'mini-ajax-cart'); ?></option>
						<option value="available_icon" <?php if(isset($cart_basket['close_icon_type'])) { selected($cart_basket['close_icon_type'], 'available_icon'); } ?>><?php esc_html_e('Available Icon', 'mini-ajax-cart'); ?></option>
						<option value="custom_icon" <?php if(isset($cart_basket['close_icon_type'])) { selected($cart_basket['close_icon_type'], 'custom_icon'); } ?>><?php esc_html_e('Custom Icon', 'mini-ajax-cart'); ?></option>
					</select>
				</div>
			</div>
		...
		<div class="majc-settings-field">
			...
			<div class="majc-settings-input-field">
				<select name="majc_settings[cart_basket][shape]">
					<option value="round" <?php if( isset($cart_basket['shape']) ) { selected($cart_basket['shape'], 'round'); } ?>><?php esc_html_e('Round', 'mini-ajax-cart'); ?></option>
					<option value="square" <?php if( isset($cart_basket['shape']) ) { selected($cart_basket['shape'], 'square'); } ?>><?php esc_html_e('Square', 'mini-ajax-cart'); ?></option>
					<option value="rounded_square" <?php if( isset($cart_basket['shape']) ) { selected($cart_basket['shape'], 'rounded_square'); } ?>><?php esc_html_e('Rounded Square', 'mini-ajax-cart'); ?></option>
				</select>
			</div>
		</div>
		...
		<div class="majc-settings-field">
			...
			<div class="majc-settings-input-field">
				<input type="checkbox" name="majc_settings[cart_basket][product_count]" <?php if(isset($cart_basket['product_count'])) { checked( $cart_basket['product_count'], 'on', true ); } ?>>
			</div>
		</div>
				...
				<select name="majc_settings[cart_basket][hover_animation]">
					...
					<?php foreach ($animations['hover_animation'] as $type => $type_array): ?>
						...
						<?php foreach ($type_array as $key => $value): ?>
							<option value="<?php echo esc_attr($value) ?>" <?php if(isset($majc_settings['cart_basket']['hover_animation']) ) { selected($majc_settings['cart_basket']['hover_animation'], $value); } ?>><?php echo esc_attr($key) ?></option>
						<?php endforeach ?>
					<?php endforeach ?>
				</select>
			</div>
	...
	<div class="majc-settings-field-wrap majc-settings-content">
		...
		<div class="majc-settings-field">
			...
			<div class="majc-settings-input-field">
				<input type="checkbox" name="majc_settings[summary][hide_cart_total]" <?php if(isset($summary['hide_cart_total'])) { checked( $summary['hide_cart_total'], 'on', true ); } ?>>
			</div>
		</div>
		...
		<div class="majc-settings-field">
			...
			<div class="majc-settings-input-field">
				<input type="checkbox" name="majc_settings[summary][hide_discount]" <?php if(isset($summary['hide_discount'])) { checked( $summary['hide_discount'], 'on', true ); } ?>>
			</div>
		</div>
		...
		<div class="majc-settings-field">
			...
			<div class="majc-settings-input-field">
				<input type="checkbox" name="majc_settings[summary][hide_subtotal]" <?php if(isset($summary['hide_subtotal'])) { checked( $summary['hide_subtotal'], 'on', true ); } ?>>
			</div>
		</div>
	</div>
</div>