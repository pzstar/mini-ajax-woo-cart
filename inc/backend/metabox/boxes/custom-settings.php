...
<div id="custom-settings" class="tab-content majc-settings-content" style="display: none;">
	...
	<div class="majc-settings-field">
		...
		<div class="majc-settings-input-field">
			<input type="checkbox" name="majc_settings[custom][enable]" onchange="hideShow(this)" target="majc-custom-fields" <?php if(isset($custom['enable'])) { checked( $custom['enable'], 'on', true ); } ?>>
		</div>
	</div><br>	
				            ...
				            if ($standard_fonts) {
				                ...
				                <optgroup label="Standard Fonts">
				                    <?php foreach ($standard_fonts as $standard_font) { ?>
				                        <option value="<?php echo esc_attr($standard_font); ?>" <?php if(isset($custom['header_title_font_family'])) { selected($custom['header_title_font_family'], $standard_font); } ?>><?php echo esc_attr($standard_font); ?></option>
				                    <?php } ?>
				                </optgroup>
				            <?php } ?>
				            ...
				            if ($google_fonts) {
				                ...
				                <optgroup label="Google Fonts">
				                    <?php foreach ($google_fonts as $google_font) { ?>
				                        <option value="<?php echo esc_attr($google_font); ?>" <?php if(isset($custom['header_title_font_family'])) { selected($custom['header_title_font_family'], $google_font); } ?>><?php echo esc_attr($google_font); ?></option>
				                    <?php } ?>
				                </optgroup>
				            <?php } ?>
			            ...
			            <div class="majc-settings-input-field">
				            <select name="majc_settings[custom][header_title_font_style]" class="typography_font_style">
				                <?php foreach ($font_weights as $font_weight => $font_weight_label) { ?>
				                    <option value="<?php echo esc_attr($font_weight); ?>" <?php if(isset($custom['header_title_font_style'])) { selected($custom['header_title_font_style'], $font_weight); } ?>><?php echo esc_html($font_weight_label); ?></option>
				                <?php } ?>
				            </select>
			        	</div>
			        <?php } ?>
			            ...
			            <div class="majc-settings-input-field">
				            <select name="majc_settings[custom][header_title_text_transform]" class="typography_text_transform">
				                ...
				                <?php foreach ($text_transforms as $key => $value) { ?>
				                    ...
				                    <option value="<?php echo esc_attr($key) ?>" <?php if(isset($custom['header_title_text_transform'])) { selected($custom['header_title_text_transform'], $key); } ?>><?php echo esc_html($value); ?></option>
			            ...
			            <div class="majc-settings-input-field">
				            <select name="majc_settings[custom][header_title_text_decoration]" class="typography_text_decoration">
				                ...
				                <?php foreach ($text_decorations as $key => $value) { ?>
				                    ...
				                    <option value="<?php echo esc_attr($key) ?>" <?php if(isset($custom['header_title_text_decoration'])) { selected($custom['header_title_text_decoration'], $key); } ?>><?php echo esc_html($value); ?></option>
			        ...
			        <div class="majc-settings-input-field">
				        <select name="majc_settings[custom][summary_label_font_family]" class="typography_face">
				            ...
				            if ($standard_fonts) {
				                ...
				                <optgroup label="Standard Fonts">
				                    <?php foreach ($standard_fonts as $standard_font) { ?>
				                        <option value="<?php echo esc_attr($standard_font); ?>" <?php if(isset($custom['summary_label_font_family'])) { selected($custom['summary_label_font_family'], $standard_font); } ?>><?php echo esc_attr($standard_font); ?></option>
				                    <?php } ?>
				                </optgroup>
				            <?php } ?>
				            ...
				            if ($google_fonts) {
				                ...
				                <optgroup label="Google Fonts">
				                    <?php foreach ($google_fonts as $google_font) { ?>
				                        <option value="<?php echo esc_attr($google_font); ?>" <?php if(isset($custom['summary_label_font_family'])) { selected($custom['summary_label_font_family'], $google_font); } ?>><?php echo esc_attr($google_font); ?></option>
				                    <?php } ?>
				                </optgroup>
				            <?php } ?>
			        ...
			        if ($font_weights) {
			            ...
			            <div class="majc-settings-input-field">
				            <select name="majc_settings[custom][summary_label_font_style]" class="typography_font_style">
				                <?php foreach ($font_weights as $font_weight => $font_weight_label) { ?>
				                    <option value="<?php echo esc_attr($font_weight); ?>" <?php if(isset($custom['summary_label_font_style'])) { selected($custom['summary_label_font_style'], $font_weight); } ?>><?php echo esc_html($font_weight_label); ?></option>
				                <?php } ?>
				            </select>
			        	</div>
			        <?php } ?>
			            ...
			            <div class="majc-settings-input-field">
				            <select name="majc_settings[custom][summary_label_text_transform]" class="typography_text_transform">
				                ...
				                <?php foreach ($text_transforms as $key => $value) { ?>
				                    ...
				                    <option value="<?php echo esc_attr($key) ?>" <?php if(isset($custom['summary_label_text_transform'])) { selected($custom['summary_label_text_transform'], $key); } ?>><?php echo esc_html($value); ?></option>
			            ...
			            <div class="majc-settings-input-field">
				            <select name="majc_settings[custom][summary_label_text_decoration]" class="typography_text_decoration">
				                ...
				                <?php foreach ($text_decorations as $key => $value) { ?>
				                    ...
				                    <option value="<?php echo esc_attr($key) ?>" <?php if(isset($custom['summary_label_text_decoration'])) { selected($custom['summary_label_text_decoration'], $key); } ?>><?php echo esc_html($value); ?></option>
			        ...
			        <div class="majc-settings-input-field">
				        <select name="majc_settings[custom][shipping_title_font_family]" class="typography_face">
				            ...
				            if ($standard_fonts) {
				                ...
				                <optgroup label="Standard Fonts">
				                    <?php foreach ($standard_fonts as $standard_font) { ?>
				                        <option value="<?php echo esc_attr($standard_font); ?>" <?php if(isset($custom['shipping_title_font_family'])) { selected($custom['shipping_title_font_family'], $standard_font); } ?>><?php echo esc_attr($standard_font); ?></option>
				                    <?php } ?>
				                </optgroup>
				            <?php } ?>
				            ...
				            if ($google_fonts) {
				                ...
				                <optgroup label="Google Fonts">
				                    <?php foreach ($google_fonts as $google_font) { ?>
				                        <option value="<?php echo esc_attr($google_font); ?>" <?php if(isset($custom['shipping_title_font_family'])) { selected($custom['shipping_title_font_family'], $google_font); } ?>><?php echo esc_attr($google_font); ?></option>
				                    <?php } ?>
				                </optgroup>
				            <?php } ?>
			        ...
			        if ($font_weights) {
			            ...
			            <div class="majc-settings-input-field">
				            <select name="majc_settings[custom][shipping_title_font_style]" class="typography_font_style">
				                <?php foreach ($font_weights as $font_weight => $font_weight_label) { ?>
				                    <option value="<?php echo esc_attr($font_weight); ?>" <?php if(isset($custom['shipping_title_font_style'])) { selected($custom['shipping_title_font_style'], $font_weight); } ?>><?php echo esc_html($font_weight_label); ?></option>
				                <?php } ?>
				            </select>
			        	</div>
			        <?php } ?>
			            ...
			            <div class="majc-settings-input-field">
				            <select name="majc_settings[custom][shipping_title_text_transform]" class="typography_text_transform">
				                ...
				                <?php foreach ($text_transforms as $key => $value) { ?>
				                    ...
				                    <option value="<?php echo esc_attr($key) ?>" <?php if(isset($custom['shipping_title_text_transform'])) { selected($custom['shipping_title_text_transform'], $key); } ?>><?php echo esc_html($value); ?></option>
			            ...
			            <div class="majc-settings-input-field">
				            <select name="majc_settings[custom][shipping_title_text_decoration]" class="typography_text_decoration">
				                ...
				                <?php foreach ($text_decorations as $key => $value) { ?>
				                    ...
				                    <option value="<?php echo esc_attr($key) ?>" <?php if(isset($custom['shipping_title_text_decoration'])) { selected($custom['shipping_title_text_decoration'], $key); } ?>><?php echo esc_html($value); ?></option>
			        ...
			        <div class="majc-settings-input-field">
				        <select name="majc_settings[custom][button_text_font_family]" class="typography_face">
				            ...
				            if ($standard_fonts) {
				                ...
				                <optgroup label="Standard Fonts">
				                    <?php foreach ($standard_fonts as $standard_font) { ?>
				                        <option value="<?php echo esc_attr($standard_font); ?>" <?php if(isset($custom['button_text_font_family'])) { selected($custom['button_text_font_family'], $standard_font); } ?>><?php echo esc_attr($standard_font); ?></option>
				                    <?php } ?>
				                </optgroup>
				            <?php } ?>
				            ...
				            if ($google_fonts) {
				                ...
				                <optgroup label="Google Fonts">
				                    <?php foreach ($google_fonts as $google_font) { ?>
				                        <option value="<?php echo esc_attr($google_font); ?>" <?php if(isset($custom['button_text_font_family'])) { selected($custom['button_text_font_family'], $google_font); } ?>><?php echo esc_attr($google_font); ?></option>
				                    <?php } ?>
				                </optgroup>
				            <?php } ?>
			        ...
			        if ($font_weights) {
			            ...
			            <div class="majc-settings-input-field">
				            <select name="majc_settings[custom][button_text_font_style]" class="typography_font_style">
				                <?php foreach ($font_weights as $font_weight => $font_weight_label) { ?>
				                    <option value="<?php echo esc_attr($font_weight); ?>" <?php if(isset($custom['button_text_font_style'])) { selected($custom['button_text_font_style'], $font_weight); } ?>><?php echo esc_html($font_weight_label); ?></option>
				                <?php } ?>
				            </select>
			        	</div>
			        <?php } ?>
			            ...
			            <div class="majc-settings-input-field">
				            <select name="majc_settings[custom][button_text_text_transform]" class="typography_text_transform">
				                ...
				                <?php foreach ($text_transforms as $key => $value) { ?>
				                    ...
				                    <option value="<?php echo esc_attr($key) ?>" <?php if(isset($custom['button_text_text_transform'])) { selected($custom['button_text_text_transform'], $key); } ?>><?php echo esc_html($value); ?></option>
			            ...
			            <div class="majc-settings-input-field">
				            <select name="majc_settings[custom][button_text_text_decoration]" class="typography_text_decoration">
				                ...
				                <?php foreach ($text_decorations as $key => $value) { ?>
				                    ...
				                    <option value="<?php echo esc_attr($key) ?>" <?php if(isset($custom['button_text_text_decoration'])) { selected($custom['button_text_text_decoration'], $key); } ?>><?php echo esc_html($value); ?></option>
			...
			<div class="majc-settings-field">
				...
				<div class="majc-settings-input-field">
					<select name="majc_settings[custom][drawer_content_bg_type]" onchange="hideShow(this)" target="majc-content-bg-option-field">
						<option value="none" <?php if(isset($custom['drawer_content_bg_type'])) { selected($custom['drawer_content_bg_type'], 'none'); } ?>><?php esc_html_e('None', 'mini-ajax-cart'); ?></option>
						<option value="choose_color" <?php if(isset($custom['drawer_content_bg_type'])) { selected($custom['drawer_content_bg_type'], 'choose_color'); } ?>><?php esc_html_e('Choose Color', 'mini-ajax-cart'); ?></option>
						<option value="custom_image_bg" <?php if(isset($custom['drawer_content_bg_type'])) { selected($custom['drawer_content_bg_type'], 'custom_image_bg'); } ?>><?php esc_html_e('Custom Image', 'mini-ajax-cart'); ?></option>
					</select>
				</div>
			</div>
			        ...
			        <div class="majc-settings-input-field">
				        <select name="majc_settings[custom][added_product_title_font_family]" class="typography_face">
				            ...
				            if ($standard_fonts) {
				                ...
				                <optgroup label="Standard Fonts">
				                    <?php foreach ($standard_fonts as $standard_font) { ?>
				                        <option value="<?php echo esc_attr($standard_font); ?>" <?php if(isset($custom['added_product_title_font_family'])) { selected($custom['added_product_title_font_family'], $standard_font); } ?>><?php echo esc_attr($standard_font); ?></option>
				                    <?php } ?>
				                </optgroup>
				            <?php } ?>
				            ...
				            if ($google_fonts) {
				                ...
				                <optgroup label="Google Fonts">
				                    <?php foreach ($google_fonts as $google_font) { ?>
				                        <option value="<?php echo esc_attr($google_font); ?>" <?php if(isset($custom['added_product_title_font_family'])) { selected($custom['added_product_title_font_family'], $google_font); } ?>><?php echo esc_attr($google_font); ?></option>
				                    <?php } ?>
				                </optgroup>
				            <?php } ?>
			        ...
			        if ($font_weights) {
			            ...
			            <div class="majc-settings-input-field">
				            <select name="majc_settings[custom][added_product_title_font_style]" class="typography_font_style">
				                <?php foreach ($font_weights as $font_weight => $font_weight_label) { ?>
				                    <option value="<?php echo esc_attr($font_weight); ?>" <?php if(isset($custom['added_product_title_font_style'])) { selected($custom['added_product_title_font_style'], $font_weight); } ?>><?php echo esc_html($font_weight_label); ?></option>
				                <?php } ?>
				            </select>
			        	</div>
			        <?php } ?>
			            ...
			            <div class="majc-settings-input-field">
				            <select name="majc_settings[custom][added_product_title_text_transform]" class="typography_text_transform">
				                ...
				                <?php foreach ($text_transforms as $key => $value) { ?>
				                    ...
				                    <option value="<?php echo esc_attr($key) ?>" <?php if(isset($custom['added_product_title_text_transform'])) { selected($custom['added_product_title_text_transform'], $key); } ?>><?php echo esc_html($value); ?></option>
			            ...
			            <div class="majc-settings-input-field">
				            <select name="majc_settings[custom][added_product_title_text_decoration]" class="typography_text_decoration">
				                ...
				                <?php foreach ($text_decorations as $key => $value) { ?>
				                    ...
				                    <option value="<?php echo esc_attr($key) ?>" <?php if(isset($custom['added_product_title_text_decoration'])) { selected($custom['added_product_title_text_decoration'], $key); } ?>><?php echo esc_html($value); ?></option>
			        ...
			        <div class="majc-settings-input-field">
				        <select name="majc_settings[custom][added_product_price_font_family]" class="typography_face">
				            ...
				            if ($standard_fonts) {
				                ...
				                <optgroup label="Standard Fonts">
				                    <?php foreach ($standard_fonts as $standard_font) { ?>
				                        <option value="<?php echo esc_attr($standard_font); ?>" <?php if(isset($custom['added_product_price_font_family'])) { selected($custom['added_product_price_font_family'], $standard_font); } ?>><?php echo esc_attr($standard_font); ?></option>
				                    <?php } ?>
				                </optgroup>
				            <?php } ?>
				            ...
				            if ($google_fonts) {
				                ...
				                <optgroup label="Google Fonts">
				                    <?php foreach ($google_fonts as $google_font) { ?>
				                        <option value="<?php echo esc_attr($google_font); ?>" <?php if(isset($custom['added_product_price_font_family'])) { selected($custom['added_product_price_font_family'], $google_font); } ?>><?php echo esc_attr($google_font); ?></option>
				                    <?php } ?>
				                </optgroup>
				            <?php } ?>
			        ...
			        if ($font_weights) {
			            ...
			            <div class="majc-settings-input-field">
				            <select name="majc_settings[custom][added_product_price_font_style]" class="typography_font_style">
				                <?php foreach ($font_weights as $font_weight => $font_weight_label) { ?>
				                    <option value="<?php echo esc_attr($font_weight); ?>" <?php if(isset($custom['added_product_price_font_style'])) { selected($custom['added_product_price_font_style'], $font_weight); } ?>><?php echo esc_html($font_weight_label); ?></option>
				                <?php } ?>
				            </select>
			        	</div>
			        <?php } ?>
			            ...
			            <div class="majc-settings-input-field">
				            <select name="majc_settings[custom][added_product_price_text_transform]" class="typography_text_transform">
				                ...
				                <?php foreach ($text_transforms as $key => $value) { ?>
				                    ...
				                    <option value="<?php echo esc_attr($key) ?>" <?php if(isset($custom['added_product_price_text_transform'])) { selected($custom['added_product_price_text_transform'], $key); } ?>><?php echo esc_html($value); ?></option>
			            ...
			            <div class="majc-settings-input-field">
				            <select name="majc_settings[custom][added_product_price_text_decoration]" class="typography_text_decoration">
				                ...
				                <?php foreach ($text_decorations as $key => $value) { ?>
				                    ...
				                    <option value="<?php echo esc_attr($key) ?>" <?php if(isset($custom['added_product_price_text_decoration'])) { selected($custom['added_product_price_text_decoration'], $key); } ?>><?php echo esc_html($value); ?></option>
			        ...
			        <div class="majc-settings-input-field">
				        <select name="majc_settings[custom][summary_price_font_family]" class="typography_face">
				            ...
				            if ($standard_fonts) {
				                ...
				                <optgroup label="Standard Fonts">
				                    <?php foreach ($standard_fonts as $standard_font) { ?>
				                        <option value="<?php echo esc_attr($standard_font); ?>" <?php if(isset($custom['summary_price_font_family'])) { selected($custom['summary_price_font_family'], $standard_font); } ?>><?php echo esc_attr($standard_font); ?></option>
				                    <?php } ?>
				                </optgroup>
				            <?php } ?>
				            ...
				            if ($google_fonts) {
				                ...
				                <optgroup label="Google Fonts">
				                    <?php foreach ($google_fonts as $google_font) { ?>
				                        <option value="<?php echo esc_attr($google_font); ?>" <?php if(isset($custom['summary_price_font_family'])) { selected($custom['summary_price_font_family'], $google_font); } ?>><?php echo esc_attr($google_font); ?></option>
				                    <?php } ?>
				                </optgroup>
				            <?php } ?>
			        ...
			        if ($font_weights) {
			            ...
			            <div class="majc-settings-input-field">
				            <select name="majc_settings[custom][summary_price_font_style]" class="typography_font_style">
				                <?php foreach ($font_weights as $font_weight => $font_weight_label) { ?>
				                    <option value="<?php echo esc_attr($font_weight); ?>" <?php if(isset($custom['summary_price_font_style'])) { selected($custom['summary_price_font_style'], $font_weight); } ?>><?php echo esc_html($font_weight_label); ?></option>
				                <?php } ?>
				            </select>
			        	</div>
			        <?php } ?>
			            ...
			            <div class="majc-settings-input-field">
				            <select name="majc_settings[custom][summary_price_text_transform]" class="typography_text_transform">
				                ...
				                <?php foreach ($text_transforms as $key => $value) { ?>
				                    ...
				                    <option value="<?php echo esc_attr($key) ?>" <?php if(isset($custom['summary_price_text_transform'])) { selected($custom['summary_price_text_transform'], $key); } ?>><?php echo esc_html($value); ?></option>
			            ...
			            <div class="majc-settings-input-field">
				            <select name="majc_settings[custom][summary_price_text_decoration]" class="typography_text_decoration">
				                ...
				                <?php foreach ($text_decorations as $key => $value) { ?>
				                    ...
				                    <option value="<?php echo esc_attr($key) ?>" <?php if(isset($custom['summary_price_text_decoration'])) { selected($custom['summary_price_text_decoration'], $key); } ?>><?php echo esc_html($value); ?></option>
			        ...
			        <div class="majc-settings-input-field">
				        <select name="majc_settings[custom][header_item_count_font_family]" class="typography_face">
				            ...
				            if ($standard_fonts) {
				                ...
				                <optgroup label="Standard Fonts">
				                    <?php foreach ($standard_fonts as $standard_font) { ?>
				                        <option value="<?php echo esc_attr($standard_font); ?>" <?php if(isset($custom['header_item_count_font_family'])) { selected($custom['header_item_count_font_family'], $standard_font); } ?>><?php echo esc_attr($standard_font); ?></option>
				                    <?php } ?>
				                </optgroup>
				            <?php } ?>
				            ...
				            if ($google_fonts) {
				                ...
				                <optgroup label="Google Fonts">
				                    <?php foreach ($google_fonts as $google_font) { ?>
				                        <option value="<?php echo esc_attr($google_font); ?>" <?php if(isset($custom['header_item_count_font_family'])) { selected($custom['header_item_count_font_family'], $google_font); } ?>><?php echo esc_attr($google_font); ?></option>
				                    <?php } ?>
				                </optgroup>
				            <?php } ?>
			        ...
			        if ($font_weights) {
			            ...
			            <div class="majc-settings-input-field">
				            <select name="majc_settings[custom][header_item_count_font_style]" class="typography_font_style">
				                <?php foreach ($font_weights as $font_weight => $font_weight_label) { ?>
				                    <option value="<?php echo esc_attr($font_weight); ?>" <?php if(isset($custom['header_item_count_font_style'])) { selected($custom['header_item_count_font_style'], $font_weight); } ?>><?php echo esc_html($font_weight_label); ?></option>
				                <?php } ?>
				            </select>
			        	</div>
			        <?php } ?>
			            ...
			            <div class="majc-settings-input-field">
				            <select name="majc_settings[custom][header_item_count_text_transform]" class="typography_text_transform">
				                ...
				                <?php foreach ($text_transforms as $key => $value) { ?>
				                    ...
				                    <option value="<?php echo esc_attr($key) ?>" <?php if(isset($custom['header_item_count_text_transform'])) { selected($custom['header_item_count_text_transform'], $key); } ?>><?php echo esc_html($value); ?></option>
			            ...
			            <div class="majc-settings-input-field">
				            <select name="majc_settings[custom][header_item_count_text_decoration]" class="typography_text_decoration">
				                ...
				                <?php foreach ($text_decorations as $key => $value) { ?>
				                    ...
				                    <option value="<?php echo esc_attr($key) ?>" <?php if(isset($custom['header_item_count_text_decoration'])) { selected($custom['header_item_count_text_decoration'], $key); } ?>><?php echo esc_html($value); ?></option>
