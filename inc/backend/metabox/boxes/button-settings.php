	...
	<div class="majc-settings-field-wrap">
		...
		<div class="majc-settings-field">
			...
			<div class="majc-settings-input-field">
				<input type="checkbox" name="majc_settings[buttons][show_view_cart]" <?php if(isset($buttons['show_view_cart'])) { checked( $buttons['show_view_cart'], 'on', true ); } ?>>
			</div>
		</div>
		...
		<div class="majc-settings-field">
			...
			<div class="majc-settings-input-field">
				<input type="checkbox" name="majc_settings[buttons][show_checkout]" <?php if(isset($buttons['show_checkout'])) { checked( $buttons['show_checkout'], 'on', true ); } ?>>
			</div>
		</div>
		...
		<div class="majc-settings-field">
			...
			<div class="majc-settings-input-field">
				<input type="checkbox" name="majc_settings[buttons][show_continue_shopping]" <?php if(isset($buttons['show_continue_shopping'])) { checked( $buttons['show_continue_shopping'], 'on', true ); } ?>>
			</div>
		</div>
