...
= 1.1.0 =
* Cart button getting hidden due to z index issue fixed
* more undefined index error fixed

= 1.0.8 =
* Undefined index error in typography fixed
...
= 1.0.6 =
* Code hooked to wp_footer instead of wp_head due to conflict with other plugin
...
= 1.0.2 =
* Fix CSS issue in the frontend popup
* Minor Bug fixes in the php file

= 1.0.1 =
* Merge the free and pro version data
* Add the upgrade to pro banner in backend
