    ...
    class MAJC_Class extends MAJC_Library {
        ...
        public function majc_woocommerce_install_message() {
            $message = sprintf(/* translators: Placeholders: %1$s and %2$s are <strong> tags. %3$s and %4$s are <a> tags */
                esc_html__('%1$sMini Ajax Cart for WooCommerce %2$s requires WooCommerce Plugin. Please install and activate %3$sWooCommerce%4$s.', 'mini-ajax-cart'),
                '<strong>',
                '</strong>',
        ...
        public function add_plugin_action_link($links) {
            $custom['settings'] = sprintf(
                ...
                esc_url(add_query_arg('post_type', 'ultimate-woo-cart', admin_url('edit.php'))),
                esc_attr__('Cart Settings', 'mini-ajax-cart'),
                esc_html__('Settings', 'mini-ajax-cart')
            );
