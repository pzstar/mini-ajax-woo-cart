...
if(!class_exists('MAJC_Class')) {
  ...
  $active_plugins = get_option('active_plugins') ? get_option('active_plugins') : array();
  if(!in_array('ultimate-woocommerce-cart/ultimate-woocommerce-cart.php', $active_plugins)) {
    new MAJC_Class();
  }
}