...
if ( !class_exists('MAJC_Backend') ) 
{
  ...
  class MAJC_Backend extends MAJC_Library{
    ...
    public function register_post_type() {
	    ...
	    $args = array(
			'labels'             => $labels,
			'description'        => esc_html__( 'Description.', 'mini-ajax-cart' ),
			'public'             => false,
			...
			<div class="majc-icon-box">
				<div class="majc-icon-search">
					<select>
						...
						<option value="essential-icon-list"><?php  esc_html_e('Essential Icon', 'mini-ajax-cart'); ?> </option>
                ...
                echo '<ul class="majc-icon-list essential-icon-list clearfix">';
